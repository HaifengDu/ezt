...
export class PublicAddGoodService extends BaseService implements IPublicAddGoodService{
    ...
    getGoodClass(){
     /*  let res ={data: {
      ...
      const promise = Axios.get(`http://api.scmacewill.cn:3000/apimock/getMockData?id=64`);
      return promise;
    }
    /**
     * saas环境根据分类 查询物品
    ...
    getGoodList(){
        ...
        //     "pagination": pager
        // });
        const promise = Axios.get(`http://api.scmacewill.cn:3000/apimock/getMockData?id=65`);
        return promise;
       /*  let res ={data: {
              // goodList:[{
              //   id:1,
